...
{
    [TestClass]
    public class SqliteTests : SqliteBase
    {
        public SqliteTests() : base(false)
        {
        }
        ...
        public void ConstructorTest()
        {
            ...
            Assert.AreEqual(SqliteBase.FileName, db.Address);
            Assert.AreEqual(System.IO.Path.GetFileName(SqliteBase.FileName), db.Name);
        ...
        public void GetParameterTest()
        {
            ...
            for (var constructorType = 0; constructorType < 2; constructorType++)
            {
                ...
                var param = db.GetParameter("@name", "value", SqliteType.Text);
                Assert.AreEqual("@name", param.ParameterName);
                Assert.AreEqual("value", param.Value);
                Assert.AreEqual(SqliteType.Text, ((SqliteParameter)param).SqliteType);
                Assert.AreEqual(ParameterDirection.Input, param.Direction);

                param = db.GetParameter("name", "value", SqliteType.Text);
                Assert.AreEqual("@name", param.ParameterName);
                Assert.AreEqual("value", param.Value);
                Assert.AreEqual(SqliteType.Text, ((SqliteParameter)param).SqliteType);
                Assert.AreEqual(ParameterDirection.Input, param.Direction);
        ...
        public async Task ExecuteTest()
        {
            ...
            for (var asyncType = 0; asyncType < 2; asyncType++)
            {
                for (var constructorType = 0; constructorType < 2; constructorType++)
                {
                    ...
                    Assert.AreEqual((double)0, rt.Rows[0]["COL_DEC"]);
                    Assert.AreEqual(DBNull.Value, rt.Rows[0]["COL_INT"]);
                    Assert.AreEqual("2000-12-31", rt.Rows[0]["COL_DATETIME"]);
                    ...
                    Assert.AreEqual((double)0.123, rt.Rows[0]["COL_DEC"]);
                    Assert.AreEqual((long)1234567, rt.Rows[0]["COL_INT"]);
                    Assert.AreEqual("2020-01-01", rt.Rows[0]["COL_DATETIME"]);
                    ...
                    var aryParams = new DbParameter[]
                    {
                        ...
                        , db.GetParameter("dec", 98.76, SqliteType.Real)
                        , db.GetParameter("int", 999, SqliteType.Integer)
                        , db.GetParameter("datetime", "1999-12-31", SqliteType.Text)
                    };
                    ...
                    Assert.AreEqual((double)98.76, rt.Rows[0]["COL_DEC"]);
                    Assert.AreEqual((long)999, rt.Rows[0]["COL_INT"]);
                    Assert.AreEqual("1999-12-31", rt.Rows[0]["COL_DATETIME"]);
                    ...
                    foreach (var row in rt.Rows)
                    {
                        ...
                        Assert.AreEqual((double)10, row["COL_DEC"]);
                        Assert.AreEqual((long)20, row["COL_INT"]);
                    ...
                    aryParams = new DbParameter[]
                    {
                        ...
                        , db.GetParameter("@dec", DBNull.Value, SqliteType.Real)
                        , db.GetParameter("@int", 9876, SqliteType.Integer)
                        , db.GetParameter("@datetime", "2200-03-04", SqliteType.Text)
                    };
                    cnt = (asyncType == 0)
                            ? db.Execute(sql, aryParams)
                            : await db.ExecuteAsync(sql, aryParams);
                    ...
                    Assert.AreEqual((long)9876, rt.Rows[0]["COL_INT"]);
                    Assert.AreEqual("2200-03-04", rt.Rows[0]["COL_DATETIME"]);
        ...
        public async Task GetReaderTest()
        {
            ...
            for (var asyncType = 0; asyncType < 2; asyncType++)
            {
                for (var constructorType = 0; constructorType < 2; constructorType++)
                {
                    ...
                    Assert.AreEqual((double)1, reader.GetDouble(1));
                    Assert.AreEqual((long)1, reader.GetInt64(2));
                    Assert.AreEqual("2001-01-01", reader.GetString(3));
                    Assert.IsTrue(reader.Read());
                    Assert.AreEqual("ABC", reader.GetString(0));
                    Assert.AreEqual((double)1, reader.GetDouble(1));
                    Assert.AreEqual((long)1, reader.GetInt64(2));
                    ...
                    Assert.AreEqual((double)12.345, reader.GetDouble(1));
                    Assert.AreEqual((long)12345, reader.GetInt64(2));
                    Assert.AreEqual("2016-12-13", reader.GetString(3));
        ...
        public async Task QueryTest()
        {
            ...
            for (var asyncType = 0; asyncType < 2; asyncType++)
            {
                for (var constructorType = 0; constructorType < 2; constructorType++)
                {
                    ...
                    Assert.AreEqual((double)1, rt.Rows[0]["COL_DEC"]);
                    Assert.AreEqual((long)1, rt.Rows[0]["COL_INT"]);
                    Assert.AreEqual("2001-01-01", rt.Rows[0]["COL_DATETIME"]);
                    Assert.AreEqual("ABC", rt.Rows[0][0]);
                    Assert.AreEqual((double)1, rt.Rows[0][1]);
                    Assert.AreEqual((long)1, rt.Rows[0][2]);
                    Assert.AreEqual("2001-01-01", rt.Rows[0][3]);

                    Assert.AreEqual("ABC", rt.Rows[1]["COL_STR"]);
                    Assert.AreEqual((double)1, rt.Rows[1]["COL_DEC"]);
                    Assert.AreEqual((long)1, rt.Rows[1]["COL_INT"]);
                    Assert.AreEqual("2001-01-01", rt.Rows[1]["COL_DATETIME"]);
                    Assert.AreEqual("ABC", rt.Rows[1][0]);
                    Assert.AreEqual((double)1, rt.Rows[1][1]);
                    Assert.AreEqual((long)1, rt.Rows[1][2]);
                    Assert.AreEqual("2001-01-01", rt.Rows[1][3]);

                    Assert.AreEqual("ABC", rt.Rows[2]["COL_STR"]);
                    Assert.AreEqual((double)1, rt.Rows[2]["COL_DEC"]);
                    Assert.AreEqual((long)1, rt.Rows[2]["COL_INT"]);
                    Assert.AreEqual("2001-01-01", rt.Rows[2]["COL_DATETIME"]);
                    Assert.AreEqual("ABC", rt.Rows[2][0]);
                    Assert.AreEqual((double)1, rt.Rows[2][1]);
                    Assert.AreEqual((long)1, rt.Rows[2][2]);
                    Assert.AreEqual("2001-01-01", rt.Rows[2][3]);

                    Assert.AreEqual("BB", rt.Rows[3]["COL_STR"]);
                    Assert.AreEqual((double)12.345, rt.Rows[3]["COL_DEC"]);
                    Assert.AreEqual((long)12345, rt.Rows[3]["COL_INT"]);
                    Assert.AreEqual("2016-12-13", rt.Rows[3]["COL_DATETIME"]);
                    Assert.AreEqual("BB", rt.Rows[3][0]);
                    Assert.AreEqual((double)12.345, rt.Rows[3][1]);
                    Assert.AreEqual((long)12345, rt.Rows[3][2]);
                    Assert.AreEqual("2016-12-13", rt.Rows[3][3]);
        ...
        public async Task QueryTTest()
        {
            ...
            for (var asyncType = 0; asyncType < 2; asyncType++)
            {
                for (var constructorType = 0; constructorType < 2; constructorType++)
                {
                    ...
                    Assert.AreEqual((double)1, classRows[0].COL_DEC);
                    Assert.AreEqual((long)1, classRows[0].COL_INT);
                    Assert.AreEqual("2001-01-01", classRows[0].COL_DATETIME);

                    Assert.AreEqual("ABC", classRows[1].COL_STR);
                    Assert.AreEqual((double)1, classRows[1].COL_DEC);
                    Assert.AreEqual((long)1, classRows[1].COL_INT);
                    Assert.AreEqual("2001-01-01", classRows[1].COL_DATETIME);

                    Assert.AreEqual("ABC", classRows[2].COL_STR);
                    Assert.AreEqual((double)1, classRows[2].COL_DEC);
                    Assert.AreEqual((long)1, classRows[2].COL_INT);
                    Assert.AreEqual("2001-01-01", classRows[2].COL_DATETIME);

                    Assert.AreEqual("BB", classRows[3].COL_STR);
                    Assert.AreEqual((double)12.345, classRows[3].COL_DEC);
                    Assert.AreEqual((long)12345, classRows[3].COL_INT);
                    Assert.AreEqual("2016-12-13", classRows[3].COL_DATETIME);
        ...
        private class TestTableType
        {
            ...
            public double COL_DEC { get; set; }
            public long COL_INT { get; set; }
            public string COL_DATETIME { get; set; }
        }
        ...
        public async Task FindTest()
        {
            ...
            for (var asyncType = 0; asyncType < 2; asyncType++)
            {
                for (var constructorType = 0; constructorType < 2; constructorType++)
                {
                    ...
                    Assert.IsTrue((new long[] { 1, 2, 3 }).Contains((long)rr["COL_INT"]));
                    Assert.AreEqual((double)1, rr["COL_DEC"]);
                    Assert.AreEqual("2001-01-01", rr["COL_DATETIME"]);
                    ...
                    Assert.AreEqual((double)0, rr["COL_DEC"]);
                    Assert.AreEqual("2000-12-31", rr["COL_DATETIME"]);
